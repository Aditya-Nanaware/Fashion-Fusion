...
public class EthnicWearPage {
    ...
    public EthnicWearPage(Stage stage, MaleSectionPage maleSectionPage) {
        this.stage = stage;
    ...
    private void initView() {
        ...
        ImageView imageView1 = createImageView("/trdnl_images/trdnl1.jpg");
        ImageView imageView2 = createImageView("/trdnl_images/trdnl2.jpg");
        ImageView imageView3 = createImageView("/trdnl_images/trdnl3.jpg");
        ImageView imageView4 = createImageView("/trdnl_images/trdnl4.jpg");
        ImageView imageView5 = createImageView("/trdnl_images/trdnl5.jpg");
        ImageView imageView6 = createImageView("/trdnl_images/trdnl6.jpg");
        ImageView imageView7 = createImageView("/trdnl_images/trdnl7.jpg");
        ImageView imageView8 = createImageView("/trdnl_images/traditional.jpg");
        ImageView imageView9 = createImageView("/trdnl_images/trdnl9.jpg");
        ImageView imageView10 = createImageView("/trdnl_images/trdnl10.jpg");
        ImageView imageView11 = createImageView("/trdnl_images/trdnl11.jpg");
        ImageView imageView12 = createImageView("/trdnl_images/trdn12.jpg");
        ImageView imageView13 = createImageView("/trdnl_images/trdn13.jpg");
        ImageView imageView14 = createImageView("/trdnl_images/trdn14.jpg");
        ImageView imageView15 = createImageView("/trdnl_images/trdn15.jpg");
        ...
        ImageView imageView18 = createImageView("/trdnl_images/trdn18.jpg");
        ImageView imageView19 = createImageView("/trdnl_images/trdn19.jpg");
        ImageView imageView20 = createImageView("/trdnl_images/trdn20.jpg");
        ImageView imageView21 = createImageView("/trdnl_images/trbd21.jpg");
        ImageView imageView22 = createImageView("/trdnl_images/trbd22.jpg");
        ImageView imageView23 = createImageView("/trdnl_images/trbd23.jpg");
...
/* 
        VBox hb1 = new VBox(20, trdnBox1, trdnBox2, trdnBox3);
        VBox hb2 = new VBox(20, trdnBox4, trdnBox5, trdnBox6);
        VBox hb3 = new VBox(20, trdnBox7, trdnBox8, trdnBox9);
        VBox hb4 = new VBox(20, trdnBox10, trdnBox11, trdnBox12);
        VBox hb5 = new VBox(20, trdnBox13, trdnBox14, trdnBox15);
        VBox hb6 = new VBox(20, trdnBox16, trdnBox17, trdnBox18);
        VBox hb7 = new VBox(20, trdnBox19, trdnBox20, trdnBox21);
        VBox hb8 = new VBox(20, trdnBox22, trdnBox23, trdnBox21);

        HBox hb9 = new HBox(100, hb1, hb2, hb3, hb4);
        HBox hb10 = new HBox(100, hb5, hb6, hb7, hb8);
        hb9.setTranslateX(150);
        hb10.setTranslateX(150);

        VBox vb = new VBox(hb9, hb10);
        vb.setLayoutX(120);
        ...
        HBox layoutBox = new HBox(backBox, vb);
        layoutBox.setAlignment(Pos.CENTER);

        ScrollPane spane = new ScrollPane();
        spane.setContent(layoutBox);
        spane.setPrefSize(1980, 1000);
        // spane.setLayoutX(400);
        // spane.setLayoutY(200);

        apane = new AnchorPane(spane);
        */
